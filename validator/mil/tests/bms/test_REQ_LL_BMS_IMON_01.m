...
stim = struct('t', t, 'y', I, 'label', 'I_{pack} [A]   (charge < 0)', ...
    'thresholds', {{-bms.I_OC_chg_warn,'warn'; -bms.I_OC_chg_derate,'derate'; -bms.I_OC_chg_shut,'shut'}});
...
r.signals_plot = string(val.scenario_plot(r, struct( ...
    'plot_dir', val.plot_root('mil','bms'), 'filename', 'BMS-IMON-01.png', ...
    'subtitle', 'OC charge: warn / derate / shut after debounce', ...
