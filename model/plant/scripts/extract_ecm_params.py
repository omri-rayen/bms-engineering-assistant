...
------
Output:
- model/plant/params/{r0,r1,c1,r2,c2}_lut.csv  (21 SoC x 7 T each)
- model/plant/params/ecm_params_all.csv
- model/plant/plots/ecm_*.png
"""
...
OCV_CSV  = os.path.join(SCRIPT_DIR, '..', 'params', 'ocv_lut.csv')
OUT_DATA  = os.path.join(SCRIPT_DIR, '..', 'params')
