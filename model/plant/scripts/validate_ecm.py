...
------
Output:
- model/plant/params/validation_results.csv
- model/plant/plots/trips/validation_<trip_id>.png
- model/plant/plots/validation_summary.png
- model/plant/plots/validation_rmse_vs_temp.png
"""
...
DATA_DIR  = os.path.join(SCRIPT_DIR, '..', 'params')
